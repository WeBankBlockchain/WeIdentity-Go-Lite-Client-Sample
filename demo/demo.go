...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/WeBankFinTech/WeIdentity-Go-Lite-Client-Sample/client"
	"math/big"
	rand2 "math/rand"
	"strconv"
	"time"
...
func main() {
	...
	publicKeyBigInt, privateKeyBigInt, weid, err1 := client.CreateWeId("39.106.69.187", "6001")
	if err1 == nil {
	...
	err2 := client.RegisterAuthorityIssuer("39.106.69.187", "6001", weid, issuerName, privateKey)
	if err2 == nil {
	...
	cptId, cptVersion, err3 := client.RegisterCpt("39.106.69.187", "6001", weid, cptJsonSchema, cptSignature)
	if err3 == nil {
	...
	issuer := weid
	credentialEncodeResponse, credentialJsonStr, err4 := client.CreateCredentialPojo("39.106.69.187", "6001", claim, issuer, expirationDate, cptId, privateKeyBigInt)
	if err4 == nil {
	...
	weIdDocumentInvokeResponse, err5 := client.GetWeIdDocument("39.106.69.187", "6001", weid)
	if err5 == nil {
	...
	authorityIssuerInvokeResponse, err6 := client.QueryAuthorityIssuer("39.106.69.187", "6001", weid)
	if err6 == nil {
	...
	cptInvokeResponse, err7 := client.QueryCpt("39.106.69.187", "6001", cptId)
	if err7 == nil {
	...
	verifyCredentialInvokeResponse, err8 := client.VerifyCredentialPojo("39.106.69.187", "6001", credentialJsonStr)
	if err8 == nil {
